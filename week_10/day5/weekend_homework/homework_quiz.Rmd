...
- It does not tell us directly that the model is over fitted. It just tells errors of the model. In this case, it does not look like to be overfitted, but well-fitter. 
More tests required to assess fitness. 
